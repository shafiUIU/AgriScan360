...
Door Logic:
    CLOSED = 180 deg  (pipe sealed, nothing drops through)
...
class PipeDoor:
    ...
    Usage:
        ...
        door.drop_item()   # opens 90 deg for 2s, then closes to 180 deg
    ...
    def close(self):
        """Close the pipe door to 180 deg."""
